...
import { Settings, Shield, FileText, Grid3X3, Network, HardDrive, Zap, ChevronDown, Wifi, BarChart3, Timer, AlertTriangle, Cable, Activity } from 'lucide-react';
...
export default function Sidebar({ activeNav, setActiveNav }) {
  ...
  const networkItems = [
    ...
    { id: 'NetworkProcesses', label: 'Network Processes', icon: Activity },
